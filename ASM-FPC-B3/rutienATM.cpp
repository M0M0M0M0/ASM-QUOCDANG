...
int main(){
	...
	if(a>0) printf("%d to 500.000 VND\n",a);
	if(b>0) printf("%d to 200.000 VND\n",b);
	if(c>0) printf("%d to 100.000 VND\n",c);
	if(d>0) printf("%d to 50.000 VND\n",d);
	if(e>0) printf("%d to 20.000 VND\n",e);
	if(f>0)	printf("%d to 10.000 VND\n",f);
}
